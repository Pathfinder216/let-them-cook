...
- **Labels**:
  ...
  - Make-ahead capability and refrigeration/freezing requirements — seeded manual labels (e.g. "Make-ahead", "Refrigerate up to 3 days", "Night-before prep")
  - Equipment (e.g., slow cooker) — seeded manual labels (e.g. "Slow cooker", "Instant Pot / pressure cooker", "Air fryer", "Oven", "Stovetop only", "No-cook", "Grill", "Blender / food processor", "Stand mixer")
